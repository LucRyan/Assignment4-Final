#ifndef __CPhysics_h_
#define __CPhysics_h_

#include "Bullet/src/BulletDynamics/Character/btCharacterControllerInterface.h"
#include <Bullet/src/BulletCollision/CollisionDispatch/btGhostObject.h>
#include <Bullet/src/BulletCollision/CollisionShapes/btMultiSphereShape.h>
...
class ControllerPhysics : public btCharacterControllerInterface
{
private:
...
public:
	...
	ControllerPhysics(btPairCachingGhostObject * ghostObject, btConvexShape * convexShape, btScalar stepHeight,
